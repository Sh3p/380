...
bool do_remove_tail(int argc, char *argv[]);
bool do_remove_tail_quiet(int argc, char *argv[]);
...
static void console_init() {
    ...
    add_cmd("rhq", do_remove_head_quiet,
     ...
     add_cmd("rt", do_remove_tail,
	    " [v]            | Remove from tail of queue.  Optionally compare to expected value v");
    add_cmd("rtq", do_remove_tail_quiet,
	    " [v]            | Remove from tail of queue without reporting value");
